...
| Phase | Codex | Gemini |
|-------|-------|--------|
| Analysis | `scripts/dispatch/prompts/codex/analyzer.md` | `scripts/dispatch/prompts/gemini/analyzer.md` |
| Planning | `scripts/dispatch/prompts/codex/architect.md` | `scripts/dispatch/prompts/gemini/architect.md` |
